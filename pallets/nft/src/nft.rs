...
//!
//! This abstraction is implemented by [pallet_tokens::Module](../struct.Module.html).
...
pub trait UniqueAssets<AccountId> {
    ...
    type AssetId: FullCodec + Clone + Eq + TypeInfo + Debug;
    ...
    fn assets_of_account(account: &AccountId) -> Vec<Self::AssetId>;
